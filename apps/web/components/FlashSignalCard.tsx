...
interface FlashSignalCardProps {
  signal: Signal;
}

export default function FlashSignalCard({ signal }: FlashSignalCardProps) {
  ...
  return (
    <div className="card p-6 rounded-2xl">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-lg font-semibold text-yellow-400">⚡ FLASH SIGNAL</h3>
